...
export default function Dashboard() {
    ...
    const renderRequests = (requests: Request[], type: "feature" | "support") =>
        requests.length === 0 ? (
            <div className="text-gray-600 dark:text-gray-400">No posts yet</div>
        ) : (
            requests.map((request) => (
                <div key={request.id} className="p-4 mb-4 border rounded-lg shadow">
                    ...
                    <div className="text-gray-600 dark:text-gray-400 text-sm mt-2">Submitted by: {request.name}</div>
                </div>
            ))
        );
    ...
    return (
        <AuthWrapper>
            <main className="flex min-h-screen flex-col items-center justify-center p-6">
                ...
                <h1 className="text-4xl mb-6 flex-1">Dashboard</h1>
                <button
                ...
                <input
                    ...
                    className="w-full p-4 mb-6 border border-gray-300 rounded-lg text-black max-w-5xl"
                />
                <div className="w-full max-w-5xl">
                    <h2 className="text-2xl mb-4 font-semibold">In Progress</h2>
                    ...
                    <h2 className="text-2xl mt-6 mb-4 font-semibold">Complete</h2>
                    <div className="flex justify-between">
                        <div className="w-1/2 pr-2">
                            <h3 className="text-xl mb-2">Feature Requests</h3>
                            {renderRequests(filteredFeatureRequests.filter((request) => request.status === "complete"), "feature")}
