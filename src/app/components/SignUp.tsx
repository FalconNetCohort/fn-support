...
export default function SignUp() {
  ...
  return (
    <div className="w-full max-w-sm flex flex-col items-center justify-center ">
      <h1 className="text-2xl mb-4 font-semibold">Sign up for FalconSupport</h1>
      ...
      <form onSubmit={handleAuth} className="w-92">
        ...
        <p
          ...
          className="mt-0 mb-4 p-2"
        >
          Do not use your Office 365 Microsoft Password!
        </p>
        <button
          type="submit"
          className="w-full mb-3 bg-blue-500 text-white font-bold py-2 px-4 rounded-lg shadow-md hover:shadow-xl transform transition-all duration-300 hover:scale-105"
        >
          Create account
        </button>
      </form>
